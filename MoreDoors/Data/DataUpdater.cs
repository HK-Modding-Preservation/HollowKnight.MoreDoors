...
public static class DataUpdater
{
    public static void Run()
    {
        ...
        if (anyErr)
            throw new ArgumentException("Errors encountered");
    ...
    private static void RewriteDoorNamesFile(string path)
    {
        ...
        foreach (var door in DoorData.All().Keys)
    ...
    private static string ConstName(string name) =>
        name.ToUpper().Replace(" ", "_").Replace("'", "");
}
